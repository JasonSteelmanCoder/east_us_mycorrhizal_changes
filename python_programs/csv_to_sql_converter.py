...
if __name__ == "__main__":
    ...
    write_sql_query_to_make_csv_columns('phillips_nativeness', f'C:/Users/{os.getenv("MS_USER_NAME")}/Desktop/phillips_worms_in_east_us_without_native_assignment_MKT_MAC.csv')