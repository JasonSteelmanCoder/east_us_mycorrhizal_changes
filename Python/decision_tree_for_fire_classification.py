"""
This program trains a decision tree classifier to predict the fire classification (adapted 
or intolerant) of a species, based on the seven known fire characteristics of that 
tree. It can then run a number of tests to check the model's accuracy. By checking the 
permutation importance of each input column, it helps us decide which combination of 
variables might be the most predictive of fire classification.
