...
column = 'habtypcd2_descr_pub_cd'            # the column to alter
data_type = 'varchar(50)'                  # the datatype to change the column to
folder = f'C:/Users/{os.getenv("MS_USER_NAME")}/Desktop/updated_east_us_data/east_us_cond'       # the folder that has all of your state TREE tables, or state PLOT tables
...
for file_path in file_paths:
    ...
    with open(f'C:/Users/{os.getenv("MS_USER_NAME")}/Desktop/queries_to_alter_new_cond.txt', 'a') as output_file:
