...
for county_row in counties:
    ...
    # print(len(obs_in_county_t1))

    total_obs_t1 += len(obs_in_county_t1)
    ...
    # print(len(obs_in_county_t2))

    total_obs_t2 += len(obs_in_county_t2)

print(f'total obs t1: {total_obs_t1}')
print(f'total obss t2: {total_obs_t2}')